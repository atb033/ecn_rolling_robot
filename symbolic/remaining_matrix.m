function Fout = remaining_matrix( q, ~ , ddq, data)
...
Fout = [-(Ixx*omdx) + m*(-(g*r3*sqrt2by3*cos(alpha)*cos(gamma)) + g*r4*sqrt2by3*cos(alpha)*cos(gamma) - (2*g*r2*sqrt2*cos(beta)*sin(alpha))/3. + (g*r3*sqrt2*cos(beta)*sin(alpha))/3. + ...
